...
public interface OrdersMapper extends BaseMapper<Orders> {
    ...
    @Select("select order_valuation,order_is_evaluate,order_is_receipt,order_is_pay,product_id,order_create_time,product_name,product_style,product_describe,product_price,product_amount,product_create_time,order_id,order_number " +
            " from orders natural join order_product_user natural join products " +
            " where user_id = #{userId} and product_name like #{searchCon} and order_is_delete = false")
