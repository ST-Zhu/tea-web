...
public class OrdersServiceImpl extends ServiceImpl<OrdersMapper, Orders> implements OrdersService {
    ...
    @Override
    public Orders generateOrder(Integer productId, Integer productAmount_m, Boolean isGroup, Integer userId) {
    ...
    public List<com.example.entity.vo.Orders> getAllOrderByUserId(Integer userId, String searchCon) {
        ...
        for (com.example.entity.vo.Orders order : orders) {
            order.setTotalMoney(order.getProductPrice() * order.getProductAmount());
        }
        return orders;
    }
